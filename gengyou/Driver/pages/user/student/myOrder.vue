		...
		<view class="wrap">
			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
					...
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<view class="order" v-for="(res, index) in orderList[0]" :key="res.id">
								...
								<view class="bottom">
									<view v-if="res.deal == '待付款'" class="logistics btn">取消订单</view>
									<view v-if="res.deal == '交易失败' || res.deal == '交易成功' || res.deal == '待评价'" class="logistics btn">删除订单</view>
									<view v-if="res.deal == '待使用' || res.deal == '交易成功'" class="exchange btn">查看详情</view>
									<view v-if="res.deal == '待评价'" class="evaluate btn">评价</view>
									<view v-if="res.deal == '待付款'" class="evaluate btn">付款</view>
								</view>
							</view>
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<view class="order" v-for="(res, index) in  orderList[1].filter(res => res.deal == '待付款')" :key="res.id">
								<view class="top">
									<view class="left">
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;">
						<view class="page-box">
							<view class="order" v-for="(res, index) in  orderList[2].filter(res => res.deal == '待使用')" :key="res.id">
								<view class="top">
									<view class="left">
										<u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon>
										<view class="store">{{ res.store }}</view>
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<view class="order" v-for="(res, index) in  orderList[3].filter(res => res.deal == '待评价')" :key="res.id">
								<view class="top">
									<view class="left">
										<u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon>
										<view class="store">{{ res.store }}</view>
